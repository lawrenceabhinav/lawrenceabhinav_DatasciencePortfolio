---
title: "Exploring the World of Data: An EDA Journey on the Global Happiness Dataset"
format: html
editor: visual
---
...
The dataset was sourced from the [World Happiness Report](https://worldhappiness.report/), an annual publication of the United Nations Sustainable Development Solutions Network.
...
1.  **GDP vs. Happiness**: Countries with higher GDP per capita tend to have higher happiness scores.

2.  **Health and Happiness**: There is a strong positive correlation between life expectancy and happiness.

3.  **Freedom and Generosity**: Interestingly, while freedom correlated positively with happiness, generosity had a less pronounced impact.
